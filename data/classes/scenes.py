...
from .units import Rooms, AdditionalObjects
from .values import Values


def scene(action):
    def wrapper(win, flat, clock, FPS, player, clock_panel, objects):
...
class WorldScene:
    @classmethod
    def action(cls, win, world, FPS, clock):
        done = True
        while done:
...
class HomeScene:
    @classmethod
    def action(cls, win, FPS, clock, player, flat, clock_panel, add_objects):
...
class MallScene:
    @classmethod
    def action(cls, win, mall, FPS, clock):
        done = True
        while done:
...
class ProductsShopScene:
    @classmethod
    def action(cls, win, FPS, clock, player, best_goods_room, clock_panel, add_objects):
...
class PetsShopScene:
    @classmethod
    def action(cls, win, FPS, clock, player, clock_panel, pets_shop_room):
...
class WorkScene:
    @classmethod
    def action(cls, win, FPS, clock, player, office, clock_panel, add_objects):
        ...
        while done:
            ...
            #player.show_action(office.room_area)
            # ВРЕМЯ
...
class ClubScene:
    @classmethod
    def action(cls, win, FPS, clock, player, club, clock_panel, add_objects):
